...
def predict_power_quality(mean, variance, skew, kurtosis, fft1, fft2, fft3, fft4, fft5, fft6):
    # Simplified and refined logic based on observed patterns in provided data
...
input_values = st.text_input("Input values (separated by spaces):", "93.61 17266508.90 0.0404 -1.4167 12075.18 5765.56 371139.84 6869.20 16095.26 13190.00")
...
# Display sample values for users
st.write("Sample Input Values for Testing:")
